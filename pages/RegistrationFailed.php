 ...
 *  script for failed registration.
...
<title>Failed Registration - eCommerce</title>
...
<body id="page-top">
	...
	<header class="masthead bg-primary text-white text-center" style= "height: 900px">
	<h3 align='center'>Whoops... something went wrong with registration.</h3>
	<br>
	<br>
	<h5 align= 'center'><a style= "color: #2c3e50" href= "Register.php">Please try again</a></h5>
	<br>
	<h5 align= 'center'><a style= "color: #2c3e50" href= "Login.php">Need to Login?</a></h5>
