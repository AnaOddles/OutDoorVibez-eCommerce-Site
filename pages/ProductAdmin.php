...
$datas = $productAdmin->get_All_Products();
...
?>
	...
	<header class="masthead bg-primary text-white text-center"
		...
		<div>
			<h1 class="display-1">Product Administeration</h1>
		</div>
<div class="container">
		...
		<div class="container text-right d-table-cell float-right"
			...
			<p class="text-center float-left" style="color: #2c3e50;">Admin: <?php echo $_SESSION['username2']?>.&nbsp;</p>
		...
		<div class="container">
            ...
            foreach ($datas as $data) {
                ...
                echo "<td>" . $data['sub_categories'] . "</td>";
                echo "<td>" . $data['inventory'] . "</td>";
                echo "<td><a style='color: black' href = '../pages/ManageProduct.php?productID=" . $data['id_products'] . "'>Edit + Delete</a>" . "</td>";
                //echo "<td><a style='color: black' href = '../pages/DeleteProduct.php?productID=" . $data['id_products'] . "'>Delete</a>" . "</td>";
                echo "</tr>";
