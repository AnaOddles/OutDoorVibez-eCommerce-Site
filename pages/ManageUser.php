...
4/3 V1.1 Added a connection and closed
         it. 
5/17 V1.2 Added javascript confirmation 
            for deleting user 
_____________________________________
...
?>
	...
	<p style="color: #2c3e50;">Admin: <?php echo $_SESSION['username2']?>.&nbsp;</p>
		...
		<div class="form-container" style="width: 422px; padding: 0px;">
			<!-- Start of form -->
			<form action="EditUserHandler.php" method="post"
				...
				<div class="form-group">
					...
					href="DeleteUserHandler.php?userID=<?php echo $userID;?>">Delete</a> 
					</button>
				</div>
			</form>
		</div>
		<div class="form-container" style="width: 422px;
