 ...
 * Author:  Ana Sanchez
 * Date:    4/4/2019
 * File:    OrderFailed.php
 * Version: 1.0
 *
 * Script that is used to displayed 
 * if a user attempts to complete 
 * an incomplete order. 
...
<title>Order Failed- eCommerce</title>
...
<body id="page-top">
	...
	<h3>Order Failed</h3>
		<h5>Whoops.. incomplete order.</h5>
		<p>Sorry <?php echo $_SESSION['username2'];?>, we can't let you go hiking without equipment!</p>
		<br>
		<br>
		<h5><a style= "color: #2c3e50" href="ShoppingCart.php">Shopping Cart</a></h5>
	</header>
