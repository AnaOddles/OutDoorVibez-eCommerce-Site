	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="nav navbar-nav ml-auto">
				...
				<li class="nav-item mx-0 mx-lg-1" role="presentation"><a
					class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
					href="pages/ViewProducts.php">Products</a></li>	
					<?php 
					//Start the session
				...
				<li class="nav-item mx-0 mx-lg-1" role="presentation">
					<a href="pages/ShoppingCart.php"><img src="assets/img/cart.png"class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
